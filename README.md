...
I make unpredictable LLMs dependable enough to build real infrastructure on.
...
I write up what I build — and what the numbers actually showed, including when they didn't match what I expected:
...
*Always up for a conversation about backend engineering or putting LLMs into production.*
