...
- 🤖 Building **LLM systems end to end** - pipelines, agents, structured outputs, and the retrieval evaluation that proves whether they actually work
- 📐 Increasingly drawn to the layer beneath the tools — what makes a system reliable and scalable, and what each design choice trades away
...
*Open to conversations about backend engineering and building reliable LLM systems*
